    ...
    <nav className="fixed top-0 w-full z-50 bg-genie-dark bg-opacity-80 backdrop-blur-md py-4">
      <div className="container flex items-center justify-between">
        ...
        <div className="hidden md:flex space-x-6 items-center">
          ...
          <a href="#how-it-works" className="text-genie-cream hover:text-genie-purple-light transition-colors">How it works</a>
          <a href="#beta" className="text-genie-cream hover:text-genie-purple-light transition-colors">Beta</a>
